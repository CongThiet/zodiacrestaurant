...
@section('content')
<div class="col-md-12 box-page relative">
        ...
        <div class="content-cart">
            ...
            <table class="table table-hover table-cart ">
                ...
                @foreach($product_cart as $product)
                    <tr>
                        <td class="col-md-4 order-id-product"><strong>{{$product['item']['productName']}}</strong></td>
                        <td class="col-md-1 text-center">
                            <strong>{{$product['quantity']}}</strong>
                        </td>
                        <td class="col-md-2 text-center">{{number_format($product['item']['price'],1)}}00 VNĐ</td>
                        <td class="col-md-2 text-right"><strong>{{number_format($product['price'],1)}}00 VNĐ</strong></td>
                        <td class="col-md-2 button-add-remove">
            ...
            <a href="{{route('home')}}/#menu" style="text-decoration: none;">
                <button type="button" class="btn btn-info" style="margin-bottom: 30px;">
